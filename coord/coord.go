...
// RotateX rotates around X axis using sine and cosine of rotation angle.
//
// (This is useful for translating between equatorial and ecliptic coordinates,
// for example.)
//
// It sets z = a rotated by sin, cos; returns z.
...
func (z *Cart) Mult3(rm *M3, a *Cart) *Cart {
	// first parameter named rm to suggest common use as a rotation matrix.
	*z = Cart{
